...
part of 'candidate_follower_api_service.dart';
...
class _CandidateFollowerApiService implements CandidateFollowerApiService {
  _CandidateFollowerApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<BaseResponse<void>> followEmployer(String employerId) async {
    ...
    final _options = _setStreamType<BaseResponse<void>>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/candidates/followers/${employerId}',
