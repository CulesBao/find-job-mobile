...
part of 'employer_profile_api_service.dart';
...
class _EmployerProfileApiService implements EmployerProfileApiService {
  _EmployerProfileApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  filterEmployerProfile(
    FilterEmployerProfileRequest filter,
    int page,
    int size,
  ) async {
    final _extra = <String, dynamic>{};
