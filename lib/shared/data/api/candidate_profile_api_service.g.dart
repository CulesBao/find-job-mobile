...
class _CandidateProfileApiService implements CandidateProfileApiService {
  ...
  filterCandidateProfile(
    FilterCandidateProfileRequest filter,
    int page,
    int size,
  ) async {
    final _extra = <String, dynamic>{};
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<BaseResponse<PageableResponse<CandidateFilterDto>>>(
          Options(method: 'GET', headers: _headers, extra: _extra)
              .compose(
                _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<PageableResponse<CandidateFilterDto>> _value;
    try {
      _value = BaseResponse<PageableResponse<CandidateFilterDto>>.fromJson(
        _result.data!,
        (json) => PageableResponse<CandidateFilterDto>.fromJson(
          json as Map<String, dynamic>,
          (json) => CandidateFilterDto.fromJson(json as Map<String, dynamic>),
        ),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
