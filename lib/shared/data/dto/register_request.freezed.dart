...
abstract class $RegisterRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String email, String password, Provider provider, Role role});
}
...
class _$RegisterRequestImpl implements _RegisterRequest {
  ...
  @override
  String toString() {
    return 'RegisterRequest(email: $email, password: $password, provider: $provider, role: $role)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, email, password, provider, role);
